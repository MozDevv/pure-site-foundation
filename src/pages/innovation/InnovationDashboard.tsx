...
export function InnovationDashboard() {
  ...
  return (
    <div className="min-h-screen bg-muted/30">
      {/* Header */}
      <div
        className="mx-16 rounded-2xl overflow-hidden shadow-xl 
  bg-gradient-to-r from-blue-800 via-blue-700 to-blue-800"
      >
        <div className="max-w-7xl mx-auto px-6  flex flex-col md:flex-row items-center gap-8">
          {/* Text Section */}
          <div className="flex-1 flex flex-col gap-3">
            <span className="uppercase text-xs tracking-widest text-blue-200 font-semibold">
              Innovation Hub
            </span>
            ...
            <p className="text-blue-100 max-w-2xl">
              Where ideas are built, teams are formed, and innovation becomes
              reality.
            </p>
          </div>
                  ...
                  {activities.slice(0, 5).map((activity) => {
                    ...
                    return (
                      <div key={activity.id} className="flex items-start gap-3">
                        <div
                          className={`h-9 w-9 rounded-full ${getActivityColor(
                            activity.type
