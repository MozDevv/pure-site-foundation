...
const mockUsers = {
  student: { name: "John Doe", email: "john.doe@email.com", avatar: "/placeholder.svg", role: "Student" },
  tutor: { name: "Dr. Sarah Chen", email: "sarah.chen@techai.foundation", avatar: "/placeholder.svg", role: "Tutor" },
  admin: { name: "Admin User", email: "admin@techai.foundation", avatar: "/placeholder.svg", role: "Admin" }
};
...
export default function TimetablePage() {
  ...
  const getSidebar = () => {
    switch(role) {
      ...
      case "tutor": return <TutorSidebar />;
