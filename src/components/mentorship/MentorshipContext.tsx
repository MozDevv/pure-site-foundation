...
interface MentorshipContextType {
  ...
  // Fetch methods
  fetchMentors: (filters?: { status?: string; expertise?: string }) => Promise<void>;
  fetchMentees: (filters?: { status?: string }) => Promise<void>;
  fetchRequests: (filters?: { status?: string }) => Promise<void>;
  fetchMatches: (filters?: { status?: string; mentorId?: string; menteeId?: string }) => Promise<void>;
  fetchGroups: (filters?: { mentorId?: string; status?: string }) => Promise<void>;
  fetchSessions: (filters?: { mentorId?: string; menteeId?: string; groupId?: string; status?: string }) => Promise<void>;
  fetchGoals: (filters?: { menteeId?: string; matchId?: string }) => Promise<void>;
  ...
  createRequest: (data: Partial<MenteeRequest>) => Promise<MenteeRequest | null>;
  updateRequest: (id: string, data: Partial<MenteeRequest>) => Promise<MenteeRequest | null>;
  ...
  updateMatch: (id: string, data: Partial<MentorshipMatch>) => Promise<MentorshipMatch | null>;
  
  createGroup: (data: Partial<MentorGroup>) => Promise<MentorGroup | null>;
  updateGroup: (id: string, data: Partial<MentorGroup>) => Promise<MentorGroup | null>;
  
  createSession: (data: Partial<MentorshipSession>) => Promise<MentorshipSession | null>;
  updateSession: (id: string, data: Partial<MentorshipSession>) => Promise<MentorshipSession | null>;
  
  createGoal: (data: Partial<MenteeGoal>) => Promise<MenteeGoal | null>;
  updateGoal: (id: string, data: Partial<MenteeGoal>) => Promise<MenteeGoal | null>;
}
...
export function MentorshipProvider({ children }: { children: ReactNode }) {
  ...
  // Fetch methods
  const fetchMentors = useCallback(async (filters?: { status?: string; expertise?: string }) => {
    try {
      setLoading(true);
  ...
  const fetchMentees = useCallback(async (filters?: { status?: string }) => {
    try {
      setLoading(true);
      const data = await mentorshipApi.getMentees(filters);
      setMentees(data);
    } catch (error) {
      toast({ title: 'Error', description: 'Failed to fetch mentees', variant: 'destructive' });
    } finally {
      setLoading(false);
    }
  }, [toast]);
  ...
  const fetchMatches = useCallback(async (filters?: { status?: string; mentorId?: string; menteeId?: string }) => {
    try {
      setLoading(true);
  ...
  const fetchGroups = useCallback(async (filters?: { mentorId?: string; status?: string }) => {
    try {
      setLoading(true);
  ...
  const fetchSessions = useCallback(async (filters?: { mentorId?: string; menteeId?: string; groupId?: string; status?: string }) => {
    try {
      setLoading(true);
  ...
  const fetchGoals = useCallback(async (filters?: { menteeId?: string; matchId?: string }) => {
    try {
      setLoading(true);
  ...
  // CRUD methods
  const createMentor = useCallback(async (data: Partial<Mentor>) => {
    try {
  ...
  const approveMentor = useCallback(async (id: string) => {
    try {
  ...
  const createRequest = useCallback(async (data: Partial<MenteeRequest>) => {
    try {
  ...
  const updateRequest = useCallback(async (id: string, data: Partial<MenteeRequest>) => {
    try {
  ...
  const updateMatch = useCallback(async (id: string, data: Partial<MentorshipMatch>) => {
    try {
  ...
  const createGroup = useCallback(async (data: Partial<MentorGroup>) => {
    try {
  ...
  const updateGroup = useCallback(async (id: string, data: Partial<MentorGroup>) => {
    try {
  ...
  const createSession = useCallback(async (data: Partial<MentorshipSession>) => {
    try {
  ...
  const updateSession = useCallback(async (id: string, data: Partial<MentorshipSession>) => {
    try {
  ...
  const createGoal = useCallback(async (data: Partial<MenteeGoal>) => {
    try {
  ...
  const updateGoal = useCallback(async (id: string, data: Partial<MenteeGoal>) => {
    try {
