        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-primary-foreground/90 text-lg">
              Manage applications, cohorts, and oversee the TechAI Foundation
              program
            </p>
          </div>
          <Button
            size="lg"
            className="bg-accent text-accent-foreground hover:bg-accent-hover shadow-accent"
          >
                          ...
                          <div className="flex items-center gap-2">
                            <Dialog>
                              ...
                              <DialogContent className="max-w-2xl">
                                <DialogHeader>
                                  <DialogTitle>
                                    Student Details - {selectedUser?.name}
                                  </DialogTitle>
                                  <DialogDescription>
            ...
            <CardContent>
              <div className="text-center py-12">
                ...
                <p className="text-muted-foreground mb-4">
                  View enrollment stats, completion rates, and course
                  performance
                </p>
                <Button className="bg-primary text-primary-foreground hover:bg-primary-hover">
                  View All Courses
